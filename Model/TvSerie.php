...
class TvSerie extends Production {
  ...
  public function __construct(Media $_image = null,string $_title,string $_author,array $_genre,string $_language, string $_aired_from_year,int $_number_of_episodes,int $_number_of_seasons){
